                ...
                <div className="gap-3 ml-1 min-w-60 sm:min-w-96 lg:min-w-[35rem]">
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 mb-2" htmlFor="phoneNumber">
                            Telefon raqam (Namuna: 99 999 99 99)
                        </label>
                        <input
                            type={`number`}
                            ...
                            onChange={e => {
                                ...
                                if (val.length <= 9 && +val >= 0 && !val.startsWith('0') && !isNaN(+val)) handleInputChange('phone', e.target.value);
                            }}
                            onKeyDown={e => {
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            type={`text`}
                            id="account"
                            placeholder="Account kiriting"
                        />
                    </div>
                    <div className={'flex flex-col md:justify-end md:flex-row items-center gap-3 md:gap-6 mt-10'}>
                        <button
                            onClick={closeModal}
                            className={`w-full md:w-auto border border-green text-green rounded-md shadow-md px-6 py-3 font-semibold text-base`}>
                            Orqaga qaytish
                        ...
                        <button
                            onClick={async () => {
                                if (postData.fullName && postData.filialCode && postData.inn && postData.phone && postData.account) await postRequest()
